...
android {
    ...
    productFlavors {
        // config of full app to android market
        create("service") {
            dimension = "service"
            buildConfigField("Boolean", "IS_MOCK_MODE", "false")
        }
        create("serviceMockup") {
            dimension = "service"
            applicationIdSuffix = ".mockup" 
            versionNameSuffix = "-mockup"
    ...
    sourceSets {
        ...
        getByName("serviceMockup"){
            java.srcDirs("src/serviceMockup/java")
