package com.mtkresearch.breezeapp_ui.core.utils
...
object ColorUtils {
     ...
     * 根據訊息作者獲取顏色集
     */
    fun getMessageColors(context: Context, author: MessageAuthor): ColorSet {
        return when (author) {
            MessageAuthor.USER -> {
                val backgroundColor = ContextCompat.getColor(context, R.color.user_message_background)
                val textColor = ContextCompat.getColor(context, R.color.user_message_text)
                ColorSet(backgroundColor, textColor)
            }
            MessageAuthor.AI -> {
                val backgroundColor = ContextCompat.getColor(context, R.color.ai_message_background)
                val textColor = ContextCompat.getColor(context, R.color.ai_message_text)
                ColorSet(backgroundColor, textColor)
            }
            MessageAuthor.SYSTEM_INFO, MessageAuthor.SYSTEM_ERROR -> {
                val backgroundColor = ContextCompat.getColor(context, R.color.system_message_background)
