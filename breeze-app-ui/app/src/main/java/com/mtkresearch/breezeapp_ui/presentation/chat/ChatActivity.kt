package com.mtkresearch.breezeapp_ui.presentation.chat
...
import com.mtkresearch.breezeapp_ui.databinding.ActivityChatBinding
import com.mtkresearch.breezeapp_ui.presentation.common.base.BaseActivity
import com.mtkresearch.breezeapp_ui.presentation.chat.fragment.ChatFragment
import com.mtkresearch.breezeapp_ui.presentation.settings.fragment.RuntimeSettingsFragment
...
class ChatActivity : BaseActivity() {
        ...
        if (ev?.action == MotionEvent.ACTION_DOWN) {
            ...
            chatFragment?.view?.let { fragmentView ->
                excludeViews.addAll(listOfNotNull(
                    fragmentView.findViewById(R.id.buttonSend),
                    fragmentView.findViewById(R.id.buttonVoice),
                    fragmentView.findViewById(R.id.buttonClearChat),
                    fragmentView.findViewById(R.id.buttonNewChat)
                ))
            }
    ...
    private fun findChatFragmentViews(fragmentView: View) {
        // This is a temporary solution to access views from the fragment
        // A better approach would be to use a shared ViewModel or an event bus
        val editTextMessage: EditText = fragmentView.findViewById(R.id.editTextMessage)
        val buttonSend: ImageButton = fragmentView.findViewById(R.id.buttonSend)
        val buttonVoice: ImageButton = fragmentView.findViewById(R.id.buttonVoice)
        val buttonClearChat: Button = fragmentView.findViewById(R.id.buttonClearChat)
        val buttonNewChat: Button = fragmentView.findViewById(R.id.buttonNewChat)

        // Now you can use these views
        // Example: buttonSend.setOnClickListener { ... }
    }
