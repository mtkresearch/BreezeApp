...
import com.mtkresearch.breezeapp.presentation.settings.fragment.RuntimeSettingsFragment
        ...
        if (ev?.action == MotionEvent.ACTION_DOWN) {
            ...
            chatFragment?.view?.let { fragmentView ->
                excludeViews.addAll(listOfNotNull(
                    fragmentView.findViewById(com.mtkresearch.breezeapp.R.id.buttonSend),
                    fragmentView.findViewById(com.mtkresearch.breezeapp.R.id.buttonVoice),
                    fragmentView.findViewById(com.mtkresearch.breezeapp.R.id.buttonClearChat),
                    fragmentView.findViewById(com.mtkresearch.breezeapp.R.id.buttonNewChat)
                ))
            }
