...
import com.mtkresearch.breezeapp.presentation.common.widget.MessageBubbleViewTest
import com.mtkresearch.breezeapp.presentation.common.widget.LoadingViewTest
import com.mtkresearch.breezeapp.presentation.common.widget.ErrorViewTest
import com.mtkresearch.breezeapp.presentation.home.HomeFragmentTest
import com.mtkresearch.breezeapp.presentation.settings.RuntimeSettingsFragmentTest
import com.mtkresearch.breezeapp.presentation.settings.AppSettingsLayoutTest
 ...
 * 
 * 執行完整UI測試套件：
 * ./gradlew connectedAndroidTest --tests "com.mtkresearch.breezeapp.presentation.UITestSuite"
 * 
 * 執行特定優先級測試：
